        ...
        <div className="container">
          <div className="pricing-head_before relative mx-auto max-w-960 border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            ...
            <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]">
              ...
              <div
                className={cn(
                  "g4 pricing-head_btn_before absolute left-2 top-2 h-[calc(100%_-_16px)] w-[calc(50%_-_8px)] overflow-hidden rounded-14 shadow-400 transition-transform duration-500 before:h-100",
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-10 flex w-full justify-center">
                      <Button icon={icon}>Buy Ticket</Button>
                    </div>
