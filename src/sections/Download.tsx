...
import { logos, socials } from "../constants";
          ...
          <div className="flex items-center">
            <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
              ...
              <p className="body-1 mb-10 max-w-md">
                Stay Tuned — announcements for venue, date, lineup and early bird tickets will drop on our socials. Follow to get notified first.
              </p>
